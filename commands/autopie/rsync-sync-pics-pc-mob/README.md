...
| FOLDER_FROM | STRING | no | rsync://user@host/path/to/folder/ | --internal-config | - | The remote folder to sync to your device.<br>Should be in the format 'rsync://user@host/path/to/folder/' |
